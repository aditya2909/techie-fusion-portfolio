...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      name: "LinkedIn",
      icon: FiLinkedin,
      url: "https://linkedin.com/in/aditya2909",
      color: "hover:text-blue-400",
    },
    {
      name: "Twitter",
      icon: FiTwitter,
      url: "https://twitter.com/aditya2909",
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y: scrollY }}
        className="absolute oinset-0 overflow-hidden pointer-events-none"
      >
        <div
          className={`absolute bottom-10 left-1/4 w-64 h-64 rounded-full blur-3xl opacity-3 ${isDarkMode ? "bg-blue-500" : "bg-blue-400"}`}
        />
        <div
          className={`absolute top-10 rightt-1/3 w-48 h-48 rounded-full blur-3xl opacity-3 ${isDarkMode ? "bg-purple-500" : "bg-purple-400"}`}
        />
      </motion.div>
