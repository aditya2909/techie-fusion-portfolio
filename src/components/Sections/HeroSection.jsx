...
import PROFILE_PIC from "../../assets/images/profile-image.jpg";
        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20">
          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              {/* CTA Button - Mobile */}
              <motion.div
                className="flex flex-col sm:flex-row gap-4 jusitify-center items-center mb-8"
                variants={itemVariants}
              >
                <motion.button
                  whileHover={{ y: -2 }}
                  ...
                  className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-full text-sm uppercase tracking-wide font-medium transition-all duration-300"
                >
                  View Work
                </motion.button>
                <motion.button
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex gap-6 mb-8">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => scrollToSection("work")}
                  className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-150"
                >
                  View Work
                </motion.button>
                <motion.button
                  ...
                  className={`border ${
                    isDarkMode
                      ? "border-gray-700 hover:border-gray-600 text-gray-300"
                      : "border-gray-300 hover:border-gray-400 text-gray-700"
                  } px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-150`}
                >
                  Get in Touch
                </motion.button>
              </motion.div>
