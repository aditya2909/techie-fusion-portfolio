  ...
  return (
    ...
    >
      ...
      <motion.div className="absolute inset-0 overflow-hidden" style={{ y }}>
        ...
        />
        <div
          className={`absolute bottom-40 right-1/4 w-72 h-72 rounded-full blur-3xl opacity-5 ${
          ...
          >
            {TECH_STACK.map((tech, index) => (
              <motion.span
                ...
                className={`px-4 py-2 text-sm rounded-full border transform-all duration-300 ${
                  isDarkMode
