      ...
      <div
        className={`rounded-2xl overflow-hidden border transition-all duration-500 ${
          isDarkMode
            ...
            : "bg-white/80 border-gray-300 hover:shadow-2xl hover:shadow-blue-500/10"
        } backdrop-blur-sm`}
      >
        {/* Project Image */}
        <div className="relative overflow-hidden">
          <img
            src={project.image}
            alt={project.title}
            className="w-full h-48 object-cover transition-transform diration-500 group-hover:scale-105"
          />
          {/* Featured Badge */}
          {project.featured && (
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-black/60 backdrop-blur-xl flex items-center justify-center space-x-4"
          >
            <motion.a
